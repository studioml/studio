# -*- coding: utf-8 -*-
#
# studioml documentation build configuration file, created by
# sphinx-quickstart on Wed Aug 23 14:14:39 2017.
#
...
latex_documents = [
    (master_doc, 'studioml.tex', u'studioml Documentation',
     u'studioml', 'manual'),
]
